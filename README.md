...
簡單講，這個工具幫你**好好讀完一篇論文**，整理成一份「**每句話都能翻回原文**」的分析，還順手畫出論文的**理論架構圖**。

它最在意的一件事：**把「論文真的有寫的」跟「分析者自己腦補的」分清楚**。AI 整理論文最容易出包的地方，不是憑空亂編，而是**把自己的理解講得好像是作者原話**。所以它要求每個說法都得附上原文逐字引文、而且要能用搜尋查得到，少了就不准寫。它也**只說「這篇論文怎麼用某份文獻」**，不會幫你斷定「那份文獻原本到底在主張什麼」——那得去翻原典，是另一回事。

**怎麼用**：把論文 PDF 或 DOI 丟給 Claude，說「幫我精讀、要能查回原文、別自己腦補」就行。它會給你書目（APA7）、重點摘要、參考文獻查證（連有沒有被撤稿都查）、還有理論架構圖。

**用之前先知道**：① 它**不保證完全不出錯**，重要的東西自己再核一次；② 查證時會把論文片段送到外部搜尋，第 5 步交叉檢核還會送給別的 AI，**還沒發表的稿子要自己拿捏**；③ API 金鑰是你的密碼，**千萬別貼到聊天框**，只放自己電腦。
